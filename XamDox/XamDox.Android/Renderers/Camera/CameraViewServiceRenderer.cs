...
namespace XamDox.Droid.Renderers.Camera
{
	public class CameraViewServiceRenderer : ViewRenderer<CameraView, CameraDroid>
	{
		...
		private bool CameraPermissions()
		{
			...
			if ((int)Build.VERSION.SdkInt < 23 || ContextCompat.CheckSelfPermission(Application.Context, permission) == Permission.Granted)
			{
				return true;
			}
